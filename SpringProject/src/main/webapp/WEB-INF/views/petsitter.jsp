                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ms-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="page-scroll dd-menu collapsed" href="contact(이용자정보열람).html" data-bs-toggle="collapse"
                                        data-bs-target="#submenu-1-4" aria-controls="navbarSupportedContent"
                                        aria-expanded="false" aria-label="Toggle navigation">마이페이지</a>

                                        <ul class="sub-menu collapse" id="submenu-1-4">
                                            <li class="nav-item"><a href="contact(이용자정보열람).html">이용자 정보</a></li>
                                            <li class="nav-item"><a href="contact(펫시터입력정보).html">펫시터 정보</a></li>
                                            <li class="nav-item"><a href="contact(반려견등록).html">반려동물 선택</a></li>
                                        </ul>
                                    </li>
                                </ul>
